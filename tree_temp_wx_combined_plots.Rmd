...
## tried seperate plots to get the timelines to line up... didn't work
pers_b_ns_sensors_plot_V2 <- ggplot() +
  geom_line(data = pers_b_ns_sensors, aes(x = datetime, y = temp, linetype = "s_gb_e_tree", color = "s_gb_e_tree"), linetype = "solid", alpha = 0.5) + 
  geom_line(data = pers_b_ns_sensors, aes(x = datetime, y = temp, linetype = "s_db_s_tree", color = "s_db_s_tree"), linetype = "dashed", alpha = 0.5) + 
