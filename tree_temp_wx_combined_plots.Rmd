...
# Set layout for the combined plot
combined_ns_gbdb_plot <- layout(combined_ns_gbdn_plot, title = "Transitional and Persistent Sensor Comparison, Dead Burned (top) & Green Burned (bottom)",
                        xaxis = list(title = "Datetime"),
                        yaxis = list(title = "Temp (C)"), 
                        yaxis2 = list(title = "Temp (C)"))

# Display the combined plot
combined_ns_gbdb_plot
```
