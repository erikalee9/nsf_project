...
combined_pers_plot <- subplot(pers_b_ub_plot, plotly_pers_b_rad, nrows = 2, shareX = TRUE)

# Set layout for the combined plot
combined_pers_plot <- layout(combined_pers_plot, title = "Persistent South Aspect Sensors Tree Temps (GB, DB, UB) and Incoming SW radiation",
                        xaxis = list(title = "Datetime"),
                        yaxis = list(title = "Temp (C)"), 
                        yaxis2 = list(title = "SWin (W/m2)"),
                       showlegend = TRUE,  # Ensure legend is shown
...
#converting to a plotly
# Combine the tree temp and radiation plots vertically
combined_trans_plot <- subplot(trans_b_ub_plot, plotly_trans_b_rad, nrows = 2, shareX = TRUE)

# Set layout for the combined plot
combined_trans_plot <- layout(combined_trans_plot, title = "Transitional South Aspect Sensors Tree Temps (GB, DB, UB) and Incoming SW radiation",
                        xaxis = list(title = "Datetime"),
                        yaxis = list(title = "Temp (C)"), 
                        yaxis2 = list(title = "SWin (W/m2)"),
                       showlegend = TRUE,  # Ensure legend is shown
