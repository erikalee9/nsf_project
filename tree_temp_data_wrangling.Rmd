...
scale_color_manual(values = c("blue", "red", "blue", "red"), name = "zone_burnstatus_treename") +
  scale_linetype_manual(values = c("solid", "dashed"), name = "Region") +
...
all_s_db_sensors_plot <- ggplot() +
  ...
  scale_color_manual(values = c("blue", "green", "red", "purple"), name = "zone_burnstatus_treename") + 
scale_linetype_manual(values = c("solid", "dashed"), name = "Region") +
...
```{r}
plotly_all_s_gb_sensors_plot <- ggplotly(all_n_gb_sensors_plot)
```
