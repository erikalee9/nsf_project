...
filter(datetime_mountain>= "2023-12-07 00:00:00" & datetime_mountain <= "2024-01-10 00:00:00") %>%
...
pers_burned_rad_air<- corrected_pers_burned_wx_15min %>%
  select("datetime_mountain","datetime", "SWin_Avg", "SWout_Avg", "AirTC_Avg") %>%
  #rename datetime_mountain to datetime
  #rename(datetime = datetime_mountain) %>%
  filter(datetime_mountain >= "2023-12-19 07:00:00" & datetime_mountain <= "2024-01-10 00:00:00") %>%
  mutate(datetime_mountain = with_tz(datetime, "America/Denver"))
```
